...
function Body({ chooseTrack, spotifyApi }) {
  ...
  return (
    <section className="bg-black ml-24 py-4 space-y-6  md:max-w-5xl flex-grow md:mr-2.5">
      <Search search={search} setSearch={setSearch} />
       ...
       {/* Genres  */}
      <div className="hidden xl:inline max-w-[200px] max-h-[300px]">
        ...
        <div className="w-full pr-11">
          <h2 className="text-white font-bold mb-3">
           ...
           <div className="space-y-3  border-2 border-[#262626] rounded-2xl  pl-1 p-4 bg-[#0D0D0D] overflow-x-hidden overflow-y-scroll h-[1000px] md:h-96 scrollbar-thin scrollbar-thumb-gray-600 scrollbar-thumb-rounded hover:scrollbar-thumb-gray-500 w-[700px]">
            {searchResults.length === 0
              ? newReleases
